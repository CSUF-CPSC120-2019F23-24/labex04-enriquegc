...
int main()
{
  ...
  // so it turned it into "{" and that is because the letter was z and so the next thing up would be the "{"
  ...
  // versus hexadecimal
  //one of them goes negative because it is short will the other one is added by one becuase it is int
  ...
  // also add a comment to explain why my_short2 value became negative after
  // adding one, but my_int2 did not
  // one of them turned into 0 will the other one remained the same
